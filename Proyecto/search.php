						...
						<div class="container-fluid">
							<div class="card">
								<div class="card-header card-header-primary card-header-icon">
									...
									<h4 class="card-title">B&uacute;squeda por T&iacute;tulo</h4>
								</div>
								<div class="card-body">
									<div class="row">
										<div class="col-md-6">
										...
										<div class="col-md-6">
											<button type="button" class="btn btn-white" id="btn-limpiar" onclick="Search();"><i class="fas fa-search"></i> Buscar</button>
										</div>
									</div>
									<br><br>
									<div id="result">
